  ...
  return (
    <div className="space-y-6 max-w-xl">
      <div>
        ...
        <p className="text-white/50 text-sm mt-1">Manage your studio's plan and payments.</p>
      </div>
      <div className="glass-effect rounded-2xl p-6 space-y-4">
        <h2 className="text-white font-semibold">Current Plan</h2>
        <div className="flex items-center justify-between">
          <div>
            <p className="text-white font-bold text-lg">Studio Free</p>
            <p className="text-white/40 text-sm">Up to 5 team members</p>
          </div>
          <button
