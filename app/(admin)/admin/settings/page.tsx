...
export default function AdminSettings() {
  const [platformName, setPlatformName] = useState('AR Memories');
  ...
  return (
    <div className="space-y-6 max-w-xl">
      <div>
        ...
        <p className="text-white/50 text-sm mt-1">Platform-wide configuration.</p>
      </div>
      <div className="glass-effect rounded-2xl p-6 space-y-4">
        <h2 className="text-white font-semibold">Platform</h2>
        <form onSubmit={handleSave} className="space-y-4">
          <div>
            <label className="block text-white/50 text-sm mb-1">Platform Name</label>
          ...
          <div>
            <label className="block text-white/50 text-sm mb-1">Support Email</label>
