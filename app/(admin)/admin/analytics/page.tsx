  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-white/50 text-sm mt-1">Platform-wide metrics and growth data.</p>
      </div>
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {['New Users', 'Active Studios', 'Albums Created', 'Total Revenue'].map(label => (
      ...
      <div className="glass-effect rounded-2xl p-16 flex flex-col items-center text-center">
        ...
        <p className="text-white/30 text-sm mt-2">Platform analytics will appear as users register and engage.</p>
      </div>
    </div>
  );
}
